...
def isValidAPIKeyAgentRequest(request):
    account_id = request.headers.get("X-ACCOUNT-ID")
    account_secret = request.headers.get("X-ACCOUNT-SECRET")
    return (account_id and account_secret and account_id == account_secret)
